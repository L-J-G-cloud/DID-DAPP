      ...
      <template #default>
        ...
        <div class="balance_box">
          <p class="amount_item" v-if="store.isDonor">
            <img src="@/assets/imgs/home/amout_icon.png" alt="">
            <span>{{ t('DonorAmount') }}: <i class="F-Bold text-white">{{ donorInfo.remainingQuota }} </i> BLC</span>
          </p>

          <div class="item-info">
            <p>
              <img src="@/assets/imgs/home/blc.png" alt=""> {{ formatDecimal(info.balanceBLC, 2) }} <span>BLC</span>
            </p>
            <p v-if="payType === 1">
              <img src="@/assets/imgs/home/ftd.png" alt=""> {{ formatDecimal(info.balanceFTD, 2) }} <span>FTD</span>
            </p>
            <p v-if="payType === 2" class="fc">
              <img src="@/assets/imgs/home/fc.png" alt=""> {{ formatDecimal(info.balanceFC, 2) }} <span>FC</span>
            </p>
          </div>
        </div>
